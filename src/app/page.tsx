  ...
  return (
    <div className='min-h-screen'>
      <header className='container mx-auto px-4 py-6 flex justify-between items-center'>
        <h1 className='text-2xl font-bold'>RN Shop</h1>
      </header>
      ...
      <main className='container mx-auto px-4 py-12'>
            ...
            <div className='w-1/3'>
              ...
              >
                <Image
                  ...
                  className='rounded-3xl object-cover shadow-2xl mx-auto h-[497px] w-[250px]'
                />
        ...
        <section className='text-center'>
          ...
          <p className='text-xl  mb-8'>
            Download RN App now and get 20% off your first in-app purchase!
          </p>
          <Button size='lg' className='bg-[#1BC464] hover:bg-[#1bc464d7]'>
      ...
      <footer className='bg-[#1BC464] text-white'>
        <Link
          href={`https://github.com/kennyowj961127`}
          target='_blank'
          className='container mx-auto px-4 text-center'
        >
          <p>Copyright © {new Date().getFullYear()} RN Shop by Kenny</p>
        </Link>
      </footer>
    </div>
  );
